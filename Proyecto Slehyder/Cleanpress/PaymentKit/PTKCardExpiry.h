...
@property (nonatomic, readonly) NSString *formattedString1;
@property (nonatomic, readonly) NSString *formattedSringWithTrail;
@property (nonatomic, readonly) NSString *formattedSringWithTral;
